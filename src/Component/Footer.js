...
const Footer = () => {
  return (
    <div><footer id="footer" className="footer-1">
        ...
        <div className="row">
          ...
          <div className="col-xs-12 col-sm-6 col-md-3">
            <div className="widget no-box">
              ...
              <p>Get access to your full Health.</p>
              <a className="btn my-3" href="https://bit.ly/3m9avif" target="_blank">
                Subscribe Now
              </a>
            </div>
          </div>
      ...
      <div className="container">
        <div className="row">
          <div className="col-md-12 text-center">
            <p>Copyright Health Care Bot © 2022. All rights reserved.</p>
          </div>
        </div>
      </div>
    </div>
